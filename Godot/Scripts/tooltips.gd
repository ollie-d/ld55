...
var imp = """
turn start:
If possible, Create [wave amp=10 freq=5][color=red]1 fire[/color][/wave] in [color=green]fuser[/color] to the right of card"""

var ent = """
turn start:
If possible, Create [wave amp=10 freq=5][color=red]1 wood[/color][/wave] in [color=green]fuser[/color] left of the card"""
